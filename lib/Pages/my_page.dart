...
const String svgsetimage='assets/images/setimage.svg';
            ...
            child: Column(
              children: [
                    ...
                    children: [
                      ...
                      Positioned(
                        child: GestureDetector(
                          child: SvgPicture.asset(svgsetimage,width: 18,height: 18),
                        ),
                        left: 72,
                        top: 69,
                      )
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      Text('송윤서',style: semiBold16.copyWith(color: gray800),),
                      Text('2106',style: medium12.copyWith(color: gray600),)
                    ],
                  ),
                ),
              ],
          ...
          Padding(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('이메일',style: medium14.copyWith(color: gray800),),
          ...
          Padding(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('호실',style: medium14.copyWith(color: gray800),),
            ...
            child: Align(
              ...
              child: Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Text('로그아웃',style: regular14.copyWith(color:gray600),),
                ),
              ),
            ),
          )
